...
fn gen_grid() -> Vec<Vec<char>> {
    ...
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_10: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_11: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_12: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_13: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_14: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_15: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_16: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_17: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_18: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    // let row_19: Vec<char> = vec![
    //     ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*', ' ', '*', '*', '*', '*', ' ', '*', ' ', ' ', '*',
    // ];
    //
    // let grid: Vec<Vec<char>> = vec![
    //     row_0, row_1, row_2, row_3, row_4, row_5, row_6, row_7, row_8, row_9, row_10, row_11,
    //     row_12, row_13, row_14, row_15, row_16, row_17, row_18, row_19,
    // ];

    let count = 30;
    let grid_element: Vec<char> = vec!['*'; count];
    let grid: Vec<Vec<char>> = vec![grid_element; count];
...
fn find_neighbour(x: usize, y: usize, grid: &Vec<Vec<char>>, edge_cat: usize) -> [char; 8] {
    let focus_cell = grid[y][x];
